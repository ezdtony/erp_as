(function (c) {
  ...
  j.ext.buttons.print = {
    ...
    text: function (a) {
      return a.i18n("buttons.print", "Guardar PDF / Imprimir");
    },
    action: function (a, g, b, i) {
      ...
      i.header &&
        (d += "<thead bgcolor= '#a6fff8'>" + l(a.header, "th") + "</thead>");
      ...
      if (e) {
        ...
        "<img style='float:left' src='images/aslogo.png' height='70px' >"  +
        "<table>" +
          "<tr>" +
          "<td colspan='3' align='right'><h4>" +titulo +"</h4>"+
          "<h5>"+obra+"</h5>" +
          "<h6>"+fecha_solicitud+"</h6>" +
          "<h6>"+solicitante+"</h6>" +
          "<h6>"+codigo_solicitud+"</h6>" +
          "</td>" +
          "</tr>" +
          "<tr>" +
