...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-02-2022 a las 16:13:01
...
--
-- Base de datos: `uvzuyqbs_constructora`
--
...
INSERT INTO `areas` (`id_area`, `description`) VALUES
(1, 'Dirección General'),
(2, 'Compras'),
(3, 'Administración'),
(4, 'Campo'),
...
--
-- Estructura de tabla para la tabla `areas_level`
--

CREATE TABLE `areas_level` (
  `id_areas_level` int(11) NOT NULL,
  `id_area` int(11) NOT NULL,
  `level_description` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `areas_level`
--

INSERT INTO `areas_level` (`id_areas_level`, `id_area`, `level_description`) VALUES
(1, 1, 'Director General'),
(2, 2, 'Compras'),
(3, 3, 'Administración'),
(6, 4, 'Residente General'),
(7, 5, 'Arquitecto en Obra'),
(10, 5, 'Supervisor de Obra');
...
INSERT INTO `asignaciones_proyectos` (`id_asignaciones`, `id_proyecto`, `id_personal`, `activo`) VALUES
(1, 1, 2, 1),
(2, 1, 1, 1),
(3, 1, 3, 1);
...
--
-- Estructura de tabla para la tabla `cotizaciones_desglose`
--

CREATE TABLE `cotizaciones_desglose` (
  `id_cotizaciones_desglose` int(11) NOT NULL,
  `id_cotizaciones_index` int(11) NOT NULL,
  `numero_partida` varchar(45) DEFAULT NULL,
  `descripcion_material` varchar(45) DEFAULT NULL,
  `unidad_medicion` varchar(45) DEFAULT NULL,
  `cantidad` varchar(45) DEFAULT NULL,
  `observaciones` varchar(45) DEFAULT NULL,
  `completa` int(11) NOT NULL DEFAULT 1,
  `date_log` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `cotizaciones_desglose`
--

INSERT INTO `cotizaciones_desglose` (`id_cotizaciones_desglose`, `id_cotizaciones_index`, `numero_partida`, `descripcion_material`, `unidad_medicion`, `cantidad`, `observaciones`, `completa`, `date_log`) VALUES
(1, 1, '1', 'Tubo galvanizado pared delgada 3/4\"', 'PIEZAS', '38', '', 1, '2022-01-28 13:08:01'),
(2, 1, '2', 'Tubo galvanizado pared delgada 1/2\" ', 'PIEZAS', '15', '', 1, '2022-01-28 13:08:01'),
(3, 1, '3', 'Tubo galvanizado pared delgada 2\" ', 'PIEZAS', '4', '', 1, '2022-01-28 13:08:01'),
(4, 1, '4', 'Tubo galvanizado pared delgada 1\" ', 'PIEZAS', '4', '', 1, '2022-01-28 13:08:01'),
(5, 1, '5', 'Tubo de PCV pesado de 3/4\" ', 'PIEZAS', '30', 'Proveedor indispuesto', 0, '2022-01-28 13:08:01'),
(6, 1, '6', 'Tubo galvanizado pared gruesa 2\"', 'PIEZAS', '1', '', 0, '2022-01-28 13:08:01'),
(7, 1, '7', 'Curva de PCV pesado de 3/4\" ', 'PIEZAS', '12', '', 1, '2022-01-28 13:08:01'),
(8, 1, '8', 'Curva galvanizada pared delgada de 1\"', 'PIEZAS', '4', '', 1, '2022-01-28 13:08:01'),
(9, 1, '9', 'Conector PVC pesado de 3/4\"', 'PIEZAS', '42', '', 1, '2022-01-28 13:08:01'),
(10, 1, '10', 'Conector tipo americano de 3/4\" ', 'PIEZAS', '40', '', 1, '2022-01-28 13:08:01'),
(11, 2, '1', 'AAAAAAAAA', 'TONELADAS', '1', '', 1, '2022-01-28 13:39:06'),
(12, 3, '1', 'PPPPPPPPPPPPP', 'PIEZAS', '12', '', 1, '2022-02-04 08:33:47'),
(13, 3, '2', 'BBBBBBBBBBB', 'PIEZAS', '12', '', 1, '2022-02-04 08:33:47'),
(14, 3, '3', 'YYYYYYYYYYYY', 'PIEZAS', '8', '', 1, '2022-02-04 08:33:47');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `cotizaciones_index`
--

CREATE TABLE `cotizaciones_index` (
  `id_cotizaciones_index` int(11) NOT NULL,
  `id_lista_personal_creo` int(11) NOT NULL,
  `id_proveedores` int(11) NOT NULL,
  `consecutivo_cotizacion` varchar(50) DEFAULT NULL,
  `id_arquitecto_validacion` varchar(45) DEFAULT NULL,
  `aprovado_arquitecto` varchar(45) DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `comentarios` varchar(45) DEFAULT NULL,
  `id_enterprise_payment` int(11) DEFAULT NULL,
  `fecha_creacion` datetime DEFAULT NULL,
  `id_pagos` varchar(45) DEFAULT NULL,
  `codigo_cotizacion_prov` varchar(45) DEFAULT NULL,
  `cotizado_prov` int(11) DEFAULT NULL,
  `importe_cotizado` varchar(45) DEFAULT NULL,
  `codigo_cotizacion_chuen` varchar(45) DEFAULT NULL,
  `id_utilizacion` varchar(45) DEFAULT NULL,
  `id_proyectos` int(11) NOT NULL,
  `txt_proyectos` varchar(400) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `cotizaciones_index`
--

INSERT INTO `cotizaciones_index` (`id_cotizaciones_index`, `id_lista_personal_creo`, `id_proveedores`, `consecutivo_cotizacion`, `id_arquitecto_validacion`, `aprovado_arquitecto`, `status`, `comentarios`, `id_enterprise_payment`, `fecha_creacion`, `id_pagos`, `codigo_cotizacion_prov`, `cotizado_prov`, `importe_cotizado`, `codigo_cotizacion_chuen`, `id_utilizacion`, `id_proyectos`, `txt_proyectos`) VALUES
(1, 2, 1, 'PY1-nzg-jf3', NULL, NULL, '4', '', NULL, '2022-01-28 13:08:01', NULL, NULL, NULL, NULL, 'STGMAQ-04', '1', 1, 'STGMAQ-04 - MIGUEL ÁNGEL DE QUEVEDO'),
(2, 2, 1, 'PY1-i1n-tax', NULL, NULL, '3', '', NULL, '2022-01-28 13:39:06', NULL, NULL, NULL, NULL, 'AD2FC3R', '2', 2, 'STGMAQ-04 - MIGUEL ÁNGEL DE QUEVEDO'),
(3, 1, 1, 'PY1-kqa-wdf', NULL, NULL, '1', '', NULL, '2022-02-04 08:33:47', NULL, NULL, NULL, NULL, 'GB87G67G', '1', 1, 'STGMAQ-04 - MIGUEL ÁNGEL DE QUEVEDO');
...
CREATE TABLE `creditos` (
  ...
  `proveedor` varchar(400) DEFAULT NULL,
  `monto` varchar(100) NOT NULL,
  `saldo` varchar(50) NOT NULL,
  `fecha_pago` date DEFAULT NULL,
  `folio_fiscal` varchar(500) DEFAULT NULL,
  `ruta_pdf` varchar(500) DEFAULT NULL,
  `ruta_xml` varchar(500) DEFAULT NULL,
  `ruta_img` varchar(500) DEFAULT NULL,
...
INSERT INTO `creditos` (`id_credito`, `credit_code`, `proveedor`, `monto`, `saldo`, `fecha_pago`, `folio_fiscal`, `ruta_pdf`, `ruta_xml`, `ruta_img`, `date_log`) VALUES
(1, 'CREO23', 'PROVEEDOR', '24000', '24000', '2022-02-04', 'cev2ev2v3', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-XML-2022-02-04-1644015668.xlsx', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-PDF-2022-02-04-1644015668.pdf', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-XML-2022-02-04-1644015668.xlsx', '2022-02-04 17:01:08'),
(3, 'CD-2C0T', 'ANTONIO', '2457562', '2457562', '2022-02-05', 'WFVRWVWEW4', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-XML-2022-02-05-1644120586.xlsx', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-PDF-2022-02-05-1644120586.pdf', 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-XML-2022-02-05-1644120586.xlsx', '2022-02-05 22:09:46');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `depositos_creditos`
--

CREATE TABLE `depositos_creditos` (
  `id_depositos_creditos` int(11) NOT NULL,
  `id_credito` varchar(50) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `depositos_creditos`
--

INSERT INTO `depositos_creditos` (`id_depositos_creditos`, `id_credito`, `cantidad`, `fecha`, `origen`, `ruta_img`, `ruta_pdf`, `ruta_xml`, `folio_fiscal`) VALUES
(1, '2', '13113', '2022-02-06', NULL, '', NULL, NULL, NULL),
(2, '2', '13113', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(3, '2', '13113', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(4, '2', '13113', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(5, '2', '800', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(6, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(7, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(8, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(9, '2', '100000', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(10, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(11, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(12, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(13, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(14, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(15, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(16, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(17, '2', '15000', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(18, '2', '100', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(19, '2', '10', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(20, '2', '12000', '2022-02-06', NULL, 'uploads/ARC', NULL, NULL, NULL),
(21, '1', '12000', '2022-02-07', NULL, 'uploads/ARC', NULL, NULL, NULL),
(22, '3', '5000', '2022-02-07', NULL, 'uploads/ARCHIVOS_DE_CREDITOS/COMPROBANTES_PAGO/CRD-IMG-2022-02-07-1644244627.jpeg', NULL, NULL, NULL);
...
INSERT INTO `direcciones` (`iddirecciones`, `direccion_calle`, `direccion_numero`, `direccion_colonia`, `direccion_municipio`, `direccion_codigo_postal`, `direccion_estado`) VALUES
(1, 'Av. Miguel Ángel de Quevedo', '947', 'El Rosedal', '269', '04330', '9'),
(2, 'Av. Miguel Ángel de Quevedo', '947', 'El Rosedal', '266', '04330', '9'),
(3, 'Roble Mz 84 Lt', '3', 'Los Reyes', '657', '54900', '15'),
(4, 'Roble Mz 84 Lt', '3', 'Los Reyes', '657', '54467', '15'),
(5, 'Roble Mz 84 Lt', '3', 'Los Reyes', '657', '54900', '15');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `empresas_proveedores`
--

CREATE TABLE `empresas_proveedores` (
  `id_empresas_proveedores` int(11) NOT NULL,
  `nombre_empresa` varchar(45) DEFAULT NULL,
  `mail_empresa` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `formas_pago` (`id_formas_pago`, `descripcion`) VALUES
(1, 'N/A'),
(2, 'Efectivo'),
(3, 'Depósito'),
...
--
-- Estructura de tabla para la tabla `id_titulos`
--

CREATE TABLE `id_titulos` (
...
--
-- Volcado de datos para la tabla `id_titulos`
--

INSERT INTO `id_titulos` (`id_titulo`, `descripcion`, `short_title`) VALUES
(1, 'Licenciado', 'Lic.'),
(2, 'Ingeniero', 'Ing.'),
(3, 'Arquitecto', 'Arq.');
...
CREATE TABLE `lista_personal` (
  ...
  `aviable` int(11) NOT NULL DEFAULT 1,
...
INSERT INTO `lista_personal` (`id_lista_personal`, `id_areas_level`, `id_titulo`, `user_code`, `user_email`, `phone_number`, `user_name`, `user_lastname`, `birthdate`, `user_pass`, `active`, `aviable`, `registered_date`, `id_direccion`) VALUES
(1, 6, 2, 'LM-2021-01', 'antoniogonzalez.rt@gmail.com', NULL, 'Luis Antonio', 'González Olvera', NULL, '123', 1, 1, '2022-02-04 15:07:27', NULL),
(2, 3, 1, NULL, 'lisetmorales@gmail.com', NULL, 'Liset', 'Morales González', NULL, '123', 1, 1, '2022-02-04 15:07:54', NULL),
(3, 10, 3, 'Ga-De-Y39', 'gabriel_torre@gmail.com', '5517267813', 'Gabriel', 'De La Torre Jimenez', NULL, 'JwSEpb', 1, 1, '2022-02-04 08:10:27', 5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `matriz_materiales`
--

CREATE TABLE `matriz_materiales` (
  `id_material` int(11) NOT NULL,
  `id_utilizacion` int(11) NOT NULL,
  `id_unidades_medida` int(11) NOT NULL,
  `id_um_dimensiones` int(11) DEFAULT NULL,
  `descripcion` varchar(120) NOT NULL,
  `comentarios` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `matriz_materiales`
--

INSERT INTO `matriz_materiales` (`id_material`, `id_utilizacion`, `id_unidades_medida`, `id_um_dimensiones`, `descripcion`, `comentarios`) VALUES
(1, 1, 1, 1, 'Tubo galvanizado pared delgada', NULL),
(2, 1, 1, 1, 'Tubo de PCV pesado ', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `medicion_tipo`
--

CREATE TABLE `medicion_tipo` (
  `id_medicion_tipo` int(11) NOT NULL,
  `descripcion` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `medicion_tipo`
--

INSERT INTO `medicion_tipo` (`id_medicion_tipo`, `descripcion`) VALUES
(1, 'Piezas'),
(2, 'Metros Lineales'),
(3, 'Kilogramos'),
(4, 'Toneladas');
...
--
-- Estructura de tabla para la tabla `pagos_cotizaciones`
--

CREATE TABLE `pagos_cotizaciones` (
  `id_pagos_cotizaciones` int(11) NOT NULL,
  `id_formas_pago` int(11) NOT NULL,
  `id_cotizaciones_index` int(11) NOT NULL,
  ...
  `cantidad_pago` varchar(45) DEFAULT NULL,
  `id_usuario_que_pago` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `pagos_cotizaciones`
--

INSERT INTO `pagos_cotizaciones` (`id_pagos_cotizaciones`, `id_formas_pago`, `id_cotizaciones_index`, `id_empresa`, `url_factura`, `url_pdf`, `url_xml`, `cfdi`, `fecha_pago`, `fecha_registro`, `cantidad_pago`, `id_usuario_que_pago`, `id_proveedores`, `comentarios`, `id_enterprise_payment`, `id_credito`) VALUES
(1, 5, 1, NULL, 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-04-2022-01-28-1643397246.png', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-1PAG-PDF-2022-02-06-1644196764.pdf', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-1PAG-XML-2022-02-06-1644196764.xlsx', '2FG5353Y', '2022-01-28 00:00:00', '2022-01-28 13:14:06', '100', 1, 1, '', 1, 1),
(2, 7, 2, NULL, 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-04-2022-01-28-1643398821.png', 'uploads/TIERRA_GARAT/MIGUEL_ÁNGEL_DE_QUEVEDO1/COMPROBANTES_PAGO/WCRE3R3-2PAG-PDF-2022-02-06-1644194659.pdf', 'uploads/TIERRA_GARAT/MIGUEL_ÁNGEL_DE_QUEVEDO1/COMPROBANTES_PAGO/WCRE3R3-2PAG-XML-2022-02-06-1644194659.xlsx', 'qvf22r', '2022-01-28 00:00:00', '2022-01-28 13:40:21', '1000', 1, 2, '', 2, NULL),
(3, 3, 3, NULL, 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-04-2022-02-04-1643989844.jpeg', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-3PAG-PDF-2022-02-04-1643989882.pdf', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/COMPROBANTES_PAGO/STGMAQ-3PAG-XML-2022-02-04-1643989882.xlsx', 'EC2EC3R', '2022-02-03 00:00:00', '2022-02-04 09:50:44', '11224', 2, 1, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `payment_enterprise`
--

CREATE TABLE `payment_enterprise` (
  `id_empresa_pago_lis` int(11) NOT NULL,
  `descripcion` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `payment_enterprise`
--

INSERT INTO `payment_enterprise` (`id_empresa_pago_lis`, `descripcion`) VALUES
(1, 'CHUEN'),
(2, 'DIYCSA'),
(3, 'Otros');
...
CREATE TABLE `proveedores` (
  ...
  `num_telefonico` varchar(45) DEFAULT NULL,
  `num_fijo` varchar(45) DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `proveedores` (`id_proveedores`, `nombre_proveedor`, `empresa_proveedor`, `puesto`, `correo_proveedor`, `num_telefonico`, `num_fijo`, `status`) VALUES
(1, 'Lic. Home Depot', 'HOME DEPOT MEXICO S. DE R.L. DE C.V.', 'ING', 'hom@mail.com', '1111', '111111', 1),
(2, NULL, 'BERTHA THAIS', NULL, NULL, NULL, NULL, 1),
(3, NULL, 'CUBREPAK', NULL, NULL, NULL, NULL, 1),
(5, 'LIC.BIMBO', 'BIMBO SA DE CV', NULL, 'antoniogonzalez.rt@gmail.com', '5517267813', NULL, 1);
...
CREATE TABLE `proyectos` (
  ...
  `status` varchar(45) DEFAULT NULL,
  `cerrado_por` int(10) DEFAULT NULL,
  `id_personal_creador` int(11) DEFAULT NULL,
  `comentario` varchar(45) DEFAULT NULL,
  `fecha_inicio` date DEFAULT NULL,
  `fecha_cierre_proyectada` date NOT NULL,
  `fecha_cierre_final` date DEFAULT NULL,
  `fecha_creacion` datetime DEFAULT NULL,
...
INSERT INTO `proyectos` (`id_proyectos`, `id_tipo_proyecto`, `codigo_proyecto`, `nombre_largo`, `short_name`, `status`, `cerrado_por`, `id_personal_creador`, `comentario`, `fecha_inicio`, `fecha_cierre_proyectada`, `fecha_cierre_final`, `fecha_creacion`, `id_direccion`) VALUES
(1, 0, 'STGMAQ-04', 'MIGUEL ÁNGEL DE QUEVEDO', NULL, '1', NULL, 1, 'Proyecto piloto', '2022-01-18', '2022-01-18', NULL, '2022-01-18 12:11:00', 1),
(2, 0, 'WCRE3R3', 'TIERRA GARAT/MIGUEL ÁNGEL DE QUEVEDO1', NULL, '1', NULL, 1, 'WC', '2022-01-26', '2022-01-26', NULL, '2022-01-26 08:43:24', 2);
...
CREATE TABLE `rutas_archivos` (
  ...
  `tipo_archivo` varchar(60) DEFAULT NULL COMMENT '1.- PDF 2.- Img',
  ...
  `importe_cotizacion` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `rutas_archivos`
--

INSERT INTO `rutas_archivos` (`id_ruta`, `tipo_archivo`, `nombre_archivo`, `ruta`, `id_cotizacion`, `id_proyecto`, `otro`, `activo`, `fecha_upload`, `comentarios`, `codigo_proveedor`, `importe_cotizacion`) VALUES
(1, 'pdf', 'STGMAQ-04-2022-01-28-1643396916', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/MIGUEL_ÁNGEL_DE_QUEVEDO/cotizaciones//STGMAQ-04-2022-01-28-1643396916.pdf', 1, 1, NULL, 1, '2022-01-28 13:08:36', '', '', NULL),
(2, 'png', 'STGMAQ-04-2022-01-28-1643396938', 'uploads/MIGUEL_ÁNGEL_DE_QUEVEDO/MIGUEL_ÁNGEL_DE_QUEVEDO/cotizaciones//STGMAQ-04-2022-01-28-1643396938.png', 1, 1, NULL, 1, '2022-01-28 13:08:58', '', 'cfr3rv3rvc3', NULL);
...
INSERT INTO `status_types` (`id_status`, `descripcion`, `comentarios`, `mes`) VALUES
(1, 'Nueva', NULL, NULL),
(2, 'Pendiente', NULL, NULL),
(3, 'En cotización', NULL, NULL),
(4, 'Validada', NULL, NULL),
(5, 'Finalizada', NULL, NULL),
(6, 'Entregada', NULL, NULL),
(7, 'Recahzada', NULL, NULL),
(8, 'Autorización', NULL, NULL);
...
CREATE TABLE `tipos_proyecto` (
  ...
  `descripcion` varchar(50) NOT NULL,
  `short_name_pr` varchar(50) NOT NULL,
...
INSERT INTO `tipos_proyecto` (`id_tipo_proyecto`, `descripcion`, `short_name_pr`, `observaciones`) VALUES
(1, 'Tierra Garat', 'TG', NULL),
(2, 'Peltre', 'PT', NULL),
(3, 'Otros', 'OT', NULL);
...
--
-- Estructura de tabla para la tabla `um_dimenciones`
--

CREATE TABLE `um_dimenciones` (
  `id_um_dimensiones` int(11) NOT NULL,
  `id_unidades_medida` int(11) NOT NULL,
  `dimension` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `um_dimenciones`
--

INSERT INTO `um_dimenciones` (`id_um_dimensiones`, `id_unidades_medida`, `dimension`) VALUES
(3, 1, '3/4'),
(4, 2, '10');
...
INSERT INTO `unidades_medida` (`id_unidades_medida`, `descripcion`, `simbolo`, `short_title`) VALUES
(1, 'pulgadas', '\"', 'in'),
(2, 'centímetros', 'cm', 'cm');
...
--
-- Estructura de tabla para la tabla `utilizaciones`
--
...
--
-- Volcado de datos para la tabla `utilizaciones`
--

INSERT INTO `utilizaciones` (`id_utilizacion`, `descripcion`, `short_title`) VALUES
(1, 'Elétrico Canalización', 'ELECT. CAN.'),
(2, 'Plomería', NULL),
(3, 'Limpieza', NULL);
...
--
-- Indices de la tabla `areas_level`
--
ALTER TABLE `areas_level`
  ADD PRIMARY KEY (`id_areas_level`,`id_area`),
  ADD KEY `fk_areas_level_areas1_idx` (`id_area`);
...
--
-- Indices de la tabla `cotizaciones_desglose`
--
ALTER TABLE `cotizaciones_desglose`
  ADD PRIMARY KEY (`id_cotizaciones_desglose`,`id_cotizaciones_index`),
  ADD KEY `fk_cotizaciones_desglose_cotizaciones_index1_idx` (`id_cotizaciones_index`);

--
-- Indices de la tabla `cotizaciones_index`
--
ALTER TABLE `cotizaciones_index`
  ADD PRIMARY KEY (`id_cotizaciones_index`,`id_lista_personal_creo`,`id_proveedores`),
  ADD KEY `fk_cotizaciones_index_proveedores1_idx` (`id_proveedores`),
  ADD KEY `fk_cotizaciones_index_lista_personal1_idx` (`id_lista_personal_creo`);
...
--
-- Indices de la tabla `depositos_creditos`
--
ALTER TABLE `depositos_creditos`
  ADD PRIMARY KEY (`id_depositos_creditos`);
...
--
-- Indices de la tabla `empresas_proveedores`
--
ALTER TABLE `empresas_proveedores`
  ADD PRIMARY KEY (`id_empresas_proveedores`);
...
--
-- Indices de la tabla `id_titulos`
--
ALTER TABLE `id_titulos`
...
ALTER TABLE `lista_personal`
  ADD PRIMARY KEY (`id_lista_personal`,`id_areas_level`),
  ADD KEY `fk_lista_personal_areas_level` (`id_areas_level`);

--
-- Indices de la tabla `matriz_materiales`
--
ALTER TABLE `matriz_materiales`
  ADD PRIMARY KEY (`id_material`);

--
-- Indices de la tabla `medicion_tipo`
--
ALTER TABLE `medicion_tipo`
  ADD PRIMARY KEY (`id_medicion_tipo`);
...
--
-- Indices de la tabla `pagos_cotizaciones`
--
ALTER TABLE `pagos_cotizaciones`
  ADD PRIMARY KEY (`id_pagos_cotizaciones`,`id_formas_pago`,`id_cotizaciones_index`),
  ADD KEY `fk_pagos_cotizaciones_cotizaciones_index1_idx` (`id_cotizaciones_index`),
  ADD KEY `fk_pagos_cotizaciones_formas_pago1_idx` (`id_formas_pago`);

--
-- Indices de la tabla `payment_enterprise`
--
ALTER TABLE `payment_enterprise`
  ADD PRIMARY KEY (`id_empresa_pago_lis`);
...
--
-- Indices de la tabla `um_dimenciones`
--
ALTER TABLE `um_dimenciones`
  ADD PRIMARY KEY (`id_um_dimensiones`);

--
-- Indices de la tabla `unidades_medida`
--
ALTER TABLE `unidades_medida`
  ADD PRIMARY KEY (`id_unidades_medida`);

--
-- Indices de la tabla `utilizaciones`
--
ALTER TABLE `utilizaciones`
  ADD PRIMARY KEY (`id_utilizacion`);
...
--
-- AUTO_INCREMENT de la tabla `areas_level`
--
ALTER TABLE `areas_level`
  MODIFY `id_areas_level` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de la tabla `cotizaciones_desglose`
--
ALTER TABLE `cotizaciones_desglose`
  MODIFY `id_cotizaciones_desglose` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `cotizaciones_index`
--
ALTER TABLE `cotizaciones_index`
  MODIFY `id_cotizaciones_index` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `depositos_creditos`
--
ALTER TABLE `depositos_creditos`
  MODIFY `id_depositos_creditos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `direcciones`
--
ALTER TABLE `direcciones`
  MODIFY `iddirecciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `empresas_proveedores`
--
ALTER TABLE `empresas_proveedores`
  MODIFY `id_empresas_proveedores` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `formas_pago`
  MODIFY `id_formas_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `id_titulos`
--
ALTER TABLE `id_titulos`
...
--
ALTER TABLE `lista_personal`
  MODIFY `id_lista_personal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `matriz_materiales`
--
ALTER TABLE `matriz_materiales`
  MODIFY `id_material` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `medicion_tipo`
--
ALTER TABLE `medicion_tipo`
  MODIFY `id_medicion_tipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT de la tabla `pagos_cotizaciones`
--
ALTER TABLE `pagos_cotizaciones`
  MODIFY `id_pagos_cotizaciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `payment_enterprise`
--
ALTER TABLE `payment_enterprise`
  MODIFY `id_empresa_pago_lis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `um_dimenciones`
--
ALTER TABLE `um_dimenciones`
  MODIFY `id_um_dimensiones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `unidades_medida`
--
ALTER TABLE `unidades_medida`
  MODIFY `id_unidades_medida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `utilizaciones`
--
ALTER TABLE `utilizaciones`
  MODIFY `id_utilizacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Filtros para la tabla `areas_level`
--
ALTER TABLE `areas_level`
  ADD CONSTRAINT `fk_areas_level_areas1` FOREIGN KEY (`id_area`) REFERENCES `areas` (`id_area`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cotizaciones_desglose`
--
ALTER TABLE `cotizaciones_desglose`
  ADD CONSTRAINT `fk_cotizaciones_desglose_cotizaciones_index1` FOREIGN KEY (`id_cotizaciones_index`) REFERENCES `cotizaciones_index` (`id_cotizaciones_index`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cotizaciones_index`
--
ALTER TABLE `cotizaciones_index`
  ADD CONSTRAINT `fk_cotizaciones_index_lista_personal1` FOREIGN KEY (`id_lista_personal_creo`) REFERENCES `lista_personal` (`id_lista_personal`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cotizaciones_index_proveedores1` FOREIGN KEY (`id_proveedores`) REFERENCES `proveedores` (`id_proveedores`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `lista_personal`
--
ALTER TABLE `lista_personal`
  ADD CONSTRAINT `fk_lista_personal_areas_level` FOREIGN KEY (`id_areas_level`) REFERENCES `areas_level` (`id_areas_level`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pagos_cotizaciones`
--
ALTER TABLE `pagos_cotizaciones`
  ADD CONSTRAINT `fk_pagos_cotizaciones_cotizaciones_index1` FOREIGN KEY (`id_cotizaciones_index`) REFERENCES `cotizaciones_index` (`id_cotizaciones_index`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pagos_cotizaciones_formas_pago1` FOREIGN KEY (`id_formas_pago`) REFERENCES `formas_pago` (`id_formas_pago`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
