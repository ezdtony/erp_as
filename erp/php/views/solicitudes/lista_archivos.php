...
if ($id_solicitud == '') {
    ...
    $sql_archivos = "SELECT *  FROM constructora_personal.rutas_archivos WHERE id_cotizacion = '$id_solicitud'";
                    ...
                    <table id="basic-datatable" class="table table-striped table-centered dt-responsive w-100 mb-0">
                        ...
                        <tbody>
                            <?php foreach ($arr_archivos as $archives) :
                                $sql_entregas = "SELECT count(*) as nrows FROM constructora_personal.entregas WHERE id_rutas = '$archives->id_ruta'";
                            ...
                            ?>
                                <tr id="<?= $archives->id_ruta ?>">
                                    ...
                                    <td class="text-center">
                                        <?php
                                        if ($nrows > 0) {
                                            $sql_entrega_details = "SELECT * FROM constructora_personal.entregas WHERE id_rutas = '$archives->id_ruta'";
