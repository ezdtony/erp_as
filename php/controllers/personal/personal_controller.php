...
function sendViaticsMail()
{
                                                                    ...
                                                                    <td class="pad" style="padding-left:60px;padding-right:60px;padding-top:60px;">
                                                                        <div style="font-family: sans-serif">
                                                                            <div class style="font-size: 12px; font-family: Oswald, Lucida Sans Unicode, Lucida Grande, sans-serif; mso-line-height-alt: 21.6px; color: #FFFFFF; line-height: 1.8;">
                                                                                ...
                                                                                <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 43.2px;"><span style="font-size:24px;"><span style="font-size:24px;">Te recordamos que tienes hasta el día 25 de '.$meses[$monthNumber].' de 2022 para finalizar la comprobación de gastos pendientes</span></span></p>
    ...
    if (!empty($userData)) {
        ...
        try {
            ...
            $mail->addAddress($correo_sesion, $nombre_completo);     //Add a recipient
