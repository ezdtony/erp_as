...
$proyecto_subcarpeta = "FACTURAS";

$nm_Archivo_img = "ast_doc_" . $fecha_archivo . "-" . time();
...
if (move_uploaded_file($_FILES["factura"]["tmp_name"], $archivo_img)) {
    ...
    $sql_update_gasto = "UPDATE asteleco_viaticos.gastos SET id_ruta_pdf = '$last_id', SET id_status_type = '1' WHERE id_gastos = '$id_gasto'";
