                                    ...
                                    <div class="card bg-primary text-white mb-md-0 mb-3">
                                        <div class="card-body">
                                            <div class="card-widgets">
                                                <a data-bs-toggle="collapse" href="#card_proy<?=$proyectos->id_proyectos?>" role="button" aria-expanded="false" aria-controls="card_proy<?=$proyectos->id_proyectos?>"><i class="mdi mdi-minus"></i></a>
                                            </div>
                                            <h3><?=$proyectos->nombre_proyecto?></h3>
                                            <h5>Región <?=$proyectos->nombre_region?></h5>
                                            <h6><?=strtoupper($proyectos->codigo_proyecto)?></h6>

                                            <div id="card_proy<?=$proyectos->id_proyectos?>" class="collapse pt-3 show">
                                                <p>
