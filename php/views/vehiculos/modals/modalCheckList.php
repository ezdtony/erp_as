    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="registrarRevisionLabel">Registrar revisión</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <h4 class="header-title" id="titleDesgloseTxt<?= $familia_preguntas->id_familias_preguntas ?>" ><?= $familia_preguntas->descripcion ?> <br></h4>
                                                ...
                                                <div class="accordion accordion-flush" id="familiaPreguntas<?= $familia_preguntas->id_familias_preguntas ?>">
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="flush-heading<?= $familia_preguntas->id_familias_preguntas ?>">
                                                            <button class="accordion-button collapsed" data-hide="false" type="button" data-bs-toggle="collapse" data-id-familia-preg="<?= $familia_preguntas->id_familias_preguntas ?>" data-bs-target="#desglosePreguntas<?= $familia_preguntas->id_familias_preguntas ?>" aria-expanded="false" aria-controls="desglosePreguntas<?= $familia_preguntas->id_familias_preguntas ?>">
